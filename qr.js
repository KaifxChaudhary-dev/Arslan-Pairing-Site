		...
		try {
			...
			Qr_Code_By_Arslan_Tech.ev.on("connection.update", async (s) => {
				...
				if (connection == "open") {
				   ...
				   let session = await Qr_Code_By_Arslan_Tech.sendMessage(Qr_Code_By_Arslan_Tech.user.id, { text: 'Kaif-MD~' + b64data });
...
║❍ 𝐎𝐰𝐧𝐞𝐫: 923466859436
║❍ 𝐑𝐞𝐩𝐨: https://github.com/KaifxChaudhary-dev
║❍ 𝐖𝐚𝐆𝗿𝐨𝐮𝐩: https://whatsapp.com/channel/0029VbDMt1C3rZZaigDWAj1X
║❍ 𝐖𝐚𝐂𝐡𝐚𝐧𝐧𝐞𝐥: https://whatsapp.com/channel/0029VbDMt1C3rZZaigDWAj1X
║❍ 𝐈𝐧𝐬𝐭𝐚𝐠𝐫𝐚𝐦: _https://www.instagram.com/exotic.kaif_46
║ ☬ ☬ ☬ ☬
╚═════════════════════╝
𒂀 Enjoy Arslan-MD
